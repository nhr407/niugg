package net.modules.threadstudy.hashmap;
/**
 * 自定义HashMap
 */
public class MyHashMap<K, V> {
	...
	public void put(K newKey, V data) {
	    ...
	    if(table[hash] == null) {
	    	...
	    	while(current != null) { // we have reached lash entry of bucket.
	    		if(current.key.equals(newKey)) { //node has to be insert on first of bucket.
